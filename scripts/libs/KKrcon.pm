...
#
# In the process of being modified to support many protocols. The HLBook Project
#
# Synopsis:
#
#   use KKrcon;
...
sub execute
{
	...
	elsif($self->{"server_type"} eq "quake")
	{
	...
	{
		$self->{"error"} = "Unknown server type";
		return "";
	}
